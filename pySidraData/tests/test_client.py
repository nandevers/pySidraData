...
class TestClient(unittest.TestCase):
    ...
    def test_get_data_preview(self):
        ...
        if aggregate_ids:
            aggregate_id = aggregate_ids[0]
            data_preview = self.client.get_data_preview(table_code=aggregate_id, limit=5)
    ...
    def test_get_data_summary(self):
        ...
        if aggregate_ids:
            aggregate_id = aggregate_ids[0]
            data_summary = self.client.get_data_summary(table_code=aggregate_id, territorial_level='1', period='last')
